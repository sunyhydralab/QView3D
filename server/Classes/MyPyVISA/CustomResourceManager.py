...
class CustomResourceManager(ResourceManager):
    ...
    ResourceManager._resource_classes[constants.InterfaceType.tcpip, "INSTR"] = CustomSerialInstrument
    ResourceManager._resource_classes[constants.InterfaceType.tcpip, "SOCKET"] = CustomSerialInstrument
