...
function getDetails(currentFab: Fabricator): boolean {
  if (currentFab.id != undefined) return detailsBools.value[currentFab.id]
  else return false
}
      ...
      <div class="container mx-auto mt-3 px-2 md:px-0" v-for="currentFabricator in fabricatorList">
        ...
        <div class="overflow-x-auto w-full">
          ...
          <div class="block md:hidden">
            <div
              class="bg-light-primary-light dark:bg-dark-primary-light rounded-lg shadow mb-4 p-4"
            >
              <div class="flex justify-between mb-2">
                ...
                <div>
                  <button @click="toggleDetails(currentFabricator)" class="p-1">
                    <i
                      class="fas"
                      :class="getDetails(currentFabricator) ? 'fa-caret-up' : 'fa-caret-down'"
                    ></i>
                  </button>
                </div>
              </div>
              ...
              <div class="mb-4">
                <div class="relative w-full rounded-full h-4 overflow-hidden dark:bg-dark-primary">
                  <div
                    ...
                    :style="{
                      width:
                        getCurrentJob(currentFabricator)?.progress != null
                          ? getCurrentJob(currentFabricator)?.progress + '%'
                          : '0%',
                    }"
                  ></div>
                  <div
          ...
          <table class="hidden md:table w-full table-fixed border-collapse text-sm">
            ...
            <tbody>
              <tr class="text-center">
                ...
                >
                  <div
                    class="relative w-full rounded-full h-4 overflow-hidden dark:bg-dark-primary"
                  >
                    <div
                      class="h-full bg-gradient-to-r from-accent-primary to-accent-secondary rounded-full transition-all duration-500 ease-in-out"
                      :style="{
